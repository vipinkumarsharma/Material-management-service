...
@Entity
@Table(name = "purchase_voucher_detail")
@IdClass(PurchaseVoucherDetailId.class)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class PurchaseVoucherDetail {
    ...
    @Column(name = "pre_close_qty", precision = 15, scale = 4)
    private BigDecimal preCloseQty;

    @Column(name = "freight_amt", precision = 15, scale = 4)
    @Builder.Default
    private BigDecimal freightAmt = BigDecimal.ZERO;

    @Column(name = "gst_on_freight_amt", precision = 15, scale = 4)
    @Builder.Default
    private BigDecimal gstOnFreightAmt = BigDecimal.ZERO;
